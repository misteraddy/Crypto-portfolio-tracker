          ...
          <div className="flex flex-col items-center py-6 lg:h-[36rem] lg:flex-row">
            <div className="lg:w-1/2">
              ...
              <p className="mt-4 text-gray-100">
                Track your cryptocurrency in real-time. View live
                prices, monitor your holdings, and get insights into your
                portfolio's performance. Stay informed and make smarter
                investment decisions with our crypto portfolio tracker.
              </p>
            </div>
